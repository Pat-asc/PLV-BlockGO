...
export default function AcademicAssignment({ chairpersonDepartment = "" }) {
  ...
  const scheduleKeyFor = (section, facultyId = professor) => `${facultyId}|${program}|${section.section}|${section.schoolYear}`;
