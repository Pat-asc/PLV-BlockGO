    ...
    <div className="min-h-screen bg-slate-50 pb-10 font-sans">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <main className="mx-6 mt-4">
          ...
          {!showTransactions && activeView === 'grades' ? <StudentCurrentSubjects subjects={currentSubjects} schoolYear={currentEnrollment?.schoolYear || ''} semester={currentEnrollment?.semester || ''} loading={subjectLoading} error={subjectError} /> : null}
